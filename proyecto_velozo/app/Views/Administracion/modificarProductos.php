<section class="formularioAdministracion">
    ...
    <form class="d-flex flex-column" action="<?php echo base_url('editarProducto/' . $producto['id_producto']) ?>"
        method="post" enctype="multipart/form-data">

        <h4 class="text-center p-4">Modificar Producto</h4>
        ...
        <label>Imagen</label>
        <input class="input-imagen" type="file" name="imagen" size="20" value="<?php echo $producto['imagen'] ?>">
        <img style="max-height: 100px; object-fit: contain;"
            src="<?php echo base_url('/assets/img/Thumbnails/' . esc($producto['imagen'])); ?>" />

        <label>Categoria</label>
        <select name="categoria_id" id="categoria_id" value="<?php echo $producto['categoria_id'] ?>">
            <option name="categoria_id" value="<?php echo $producto['categoria_id'] ?>">
